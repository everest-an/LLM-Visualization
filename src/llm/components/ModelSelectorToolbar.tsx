...
export const ModelSelectorToolbar: React.FC<{
    ...
    function makeButton(egIndex: number) {
        ...
        function handleClick() {
            ...
            progState.camera.center = example.camera.center;
            progState.camera.angle = example.camera.angle;
            progState.camera.desiredCamera = undefined;
            progState.camera.desiredCameraTransition = undefined;
            progState.walkthrough.phaseTransitiveData = {};
